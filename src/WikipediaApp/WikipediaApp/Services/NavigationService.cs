...
namespace WikipediaApp
{
  public class NavigationService : INavigationService
  {
    ...
    public void ShowArticle(ArticleHead article)
    {
      ...
      var viewModel = new ArticlePageViewModel(article, App.Services.GetService<IWikipediaService>(), App.Services.GetService<IDialogService>(), App.Services.GetService<INavigationService>(), App.Services.GetService<IDisplay>(), App.Services.GetService<IAppSettings>(), App.Services.GetService<IUserSettings>(), App.Services.GetService<IArticleViewModelFactory>());
